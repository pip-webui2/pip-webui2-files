...
export class UploadFilesExampleComponent implements OnInit {
    private files: any[] = [];
    private url: string = 'http://tracker.pipservices.net:8080/api/v1/blobs/a0573d87408c4e6ebb93ff75569a821b';
    private session_id: string = '7501b38b1cea42f2b0d34d282b701e5c';
    ...
    private uploadFiles() {
        this.fileUploadService.uploadFiles(this.url, this.files, this.session_id).subscribe(
            (result: any) => {
